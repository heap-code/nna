...
# Changes: removed all fluxbox related and replaced by xfce4
#			removed some additional packages (e.g. 'tilix')
...
# NNA: add xfce4 instead onf fluxbox
package_list="
...
# NNA: start xfce4 on vnc startup
mkdir -p ~/.vnc/
